                ...
                <div className="row">
                    ...
                    <div className="col-md-10">
                        ...
                        <form onSubmit={postData}>
                            <div className="mb-3">
                                <label >Name</label>
                                <input type="text" name="name" required onChange={getInputData} placeholder='Enter Product :' className='form-control' />
                            </div>
                            ...
                            <div className="row mb-3">
                                    <div className="col-md-6">
                                        <label >Color</label>
                                        <input type="text" name="color" required onChange={getInputData} placeholder='Color' className='form-control' />
                                    </div>
                                    <div className="col-md-6">
                                        <label >Size</label>
                                        <input type="text" name="size" required onChange={getInputData} placeholder='Size' className='form-control' />
                                    </div>
                            </div>
                            <div className="row mb-3">
                                    <div className="col-md-6">
                                        <label >Base Price</label>
                                        <input type="number" name="baseprice" required onChange={getInputData} placeholder='Base Price' className='form-control w-100' />
                                    </div>
                                    <div className="col-md-6">
                                        <label >Discount</label>
                                        <input type="number" name="discount" required onChange={getInputData} placeholder='Discount' className='form-control w-100' />
                                    </div>
                            </div>
                            <div className="mb-3">
                                <label>Description</label>
                                <textarea name="description"  rows="5" required onChange={getInputData} placeholder='Product Description'value={data.description} className='form-control'></textarea>
                            </div>
                            <div className="row mb-3">
                                <div className="col-md-6">
                                <label >Pic1</label>
