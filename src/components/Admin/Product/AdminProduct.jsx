            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-secondary p-3 text-center rounded'>Product<Link to="/admin-add-product"><i className='fa fa-plus text-light float-right'></i></Link></h5>
                                            ...
                                            return <tr key={index}>
                                                ...
                                                <td>
                                                    <a href={`/assets/images/${item.pic1}`} rel="noreferrer" target="_blank">
                                                        <img src={`/assets/images/${item.pic1}`} height='70px' width='100%'  className='rounded'/>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href={`/assets/images/${item.pic2}`} rel="noreferrer" target="_blank">
                                                        <img src={`/assets/images/${item.pic2}`} height='70px' width='100%'  className='rounded'/>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href={`/assets/images/${item.pic3}`} rel="noreferrer" target="_blank">
                                                        <img src={`/assets/images/${item.pic3}`} height='70px' width='100%'  className='rounded'/>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href={`/assets/images/${item.pic4}`} rel="noreferrer" target="_blank">
                                                        <img src={`/assets/images/${item.pic4}`} height='70px' width='100%'  className='rounded'/>
                                                    </a>
                                                </td>
