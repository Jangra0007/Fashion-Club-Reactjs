            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-secondary p-3 text-center rounded'>Checkout</h5>
                                    ...
                                    </tr>
                                    {
                                        data.map((item, index) => {
                                            return <tr key={index}>
                                                ...
                                                <td>&#8377;{item.total}</td>
                                                <td>{item.date}</td>
                                                <td><Link to = {`/admin-single-checkout/${item.id}`} className='btn text-secondary' ><i className='fa fa-eye'></i></Link></td>
