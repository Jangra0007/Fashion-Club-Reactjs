            ...
            <div className="container-fluid my-2">
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h5 className='bg-secondary p-3 text-center rounded'>Maincategory</h5>
                       <form onSubmit={postData}>
                        <div className="mb-3">
                            <label >Name</label>
                            <input type="text" name="name" onChange={getInputData} placeholder='Enter Maincategory :' className='form-control' value={name} />
                        </div>
